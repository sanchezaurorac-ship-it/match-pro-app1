  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 pt-20 md:pt-24 pb-24 font-['Inter']">
        ...
        {activeTab === 'inicio' && (
          <section className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10 font-['Syne'] animate-in fade-in duration-300">
        ...
        {activeTab === 'complejos' && (
          <section id="complejos" className="mb-10 scroll-mt-24 animate-in fade-in duration-300">
        ...
        {activeTab === 'reservas' && (
          <section id="reservas" className="scroll-mt-24 animate-in fade-in duration-300">
