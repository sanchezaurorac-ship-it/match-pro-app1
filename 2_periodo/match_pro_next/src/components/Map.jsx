        ...
        {pins.map((pin) => (
          ...
          >
            <Popup className="custom-popup">
              <div className="bg-gray-900 p-2 text-center rounded-lg border border-gray-800 -m-3">
                <h4 className="text-white font-bold text-sm mb-2">{pin.name}</h4>
                <button className="bg-[#39FF14] text-black text-xs font-bold px-3 py-1.5 rounded-lg w-full transition-colors hover:bg-green-400">
                  Ver canchas
                </button>
              </div>
            </Popup>
